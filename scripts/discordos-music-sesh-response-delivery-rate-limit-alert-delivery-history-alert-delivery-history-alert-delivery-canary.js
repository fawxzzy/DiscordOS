...
} = require("./discordos-music-sesh-response-delivery-rate-limit-alert-delivery-history-alert-delivery-history-alerting");

function parseArgs(args) {
  return alertingInternals.parseArgs(args);
}

function buildRateLimitAlertDeliveryHistoryAlertDeliveryHistoryAlertDeliveryCanary(alertingResult) {
...
function validateRateLimitAlertDeliveryHistoryAlertDeliveryHistoryAlertDeliveryCanary({ alertingResult, canary }) {
...
async function buildMusicSeshResponseDeliveryRateLimitAlertDeliveryHistoryAlertDeliveryHistoryAlertDeliveryCanary(input = {}) {
  const alertingResult = await alertingInternals.buildMusicSeshResponseDeliveryRateLimitAlertDeliveryHistoryAlertDeliveryHistoryAlerting(input);
  const canary = buildRateLimitAlertDeliveryHistoryAlertDeliveryHistoryAlertDeliveryCanary(alertingResult);
  const reasonCodes = validateRateLimitAlertDeliveryHistoryAlertDeliveryHistoryAlertDeliveryCanary({ alertingResult, canary });
  const result = {
    ...
    executesStorageWrite: false,
    slashCommandsAdmitted: false,
    status: reasonCodes.length === 0 ? "music_sesh_response_delivery_rate_limit_alert_delivery_history_alert_delivery_history_alert_delivery_canary_ready" : "blocked",
...
function renderMarkdown(result) {
  return [
    "# DiscordOS Music Sesh Response Delivery Rate-Limit Alert Delivery History Alert Delivery History Alert Delivery Canary",
    "",
...
async function main() {
  try {
    ...
    const result = await buildMusicSeshResponseDeliveryRateLimitAlertDeliveryHistoryAlertDeliveryHistoryAlertDeliveryCanary(options);
...
module.exports = {
  _internals: {
    parseArgs,
    buildRateLimitAlertDeliveryHistoryAlertDeliveryHistoryAlertDeliveryCanary,
    validateRateLimitAlertDeliveryHistoryAlertDeliveryHistoryAlertDeliveryCanary,
    buildMusicSeshResponseDeliveryRateLimitAlertDeliveryHistoryAlertDeliveryHistoryAlertDeliveryCanary,
    renderMarkdown,
  },
};
