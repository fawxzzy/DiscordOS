...
const HIGHEST_VALUE_CATEGORIES = [
  {
    ...
    why: "The host-control alert delivery readback now preserves guarded admission; the next value is a scan-ready dashboard for that path.",
    does: "Summarizes host-control alert delivery readback decisions without sends, playback, or provider calls.",
  },
  {
    ...
    why: "The provider alert delivery history alerting now classifies repeated states; the next value is a guarded no-send canary.",
    does: "Proves provider admission alert delivery routing while preserving signature proof, metadata visibility, and no-provider/no-playback boundaries.",
  },
  {
    ...
    why: "The acknowledgement alert delivery canary now proves guarded admission; the next value is readback for redacted button-route state.",
    does: "Reads acknowledgement alert delivery decisions while preserving actor/token redaction and avoiding Discord API sends.",
  },
  {
    ...
    why: "The rate-limit alert delivery dashboard now gives a scan-ready state; the next value is bounded history for repeated states.",
    does: "Tracks rate-limit alert delivery dashboard records while keeping user content hidden and avoiding Discord sends.",
  },
  {
    ...
    why: "The board scheduler history alerting now classifies repeated guarded states; the next value is a no-send delivery canary.",
    does: "Proves board scheduler alert delivery admission while preserving custom-reaction guards and no-send behavior.",
  },
];
