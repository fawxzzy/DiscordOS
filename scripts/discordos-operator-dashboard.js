...
const HIGHEST_VALUE_CATEGORIES = [
  {
    ...
    why: "The host-control rollup dashboard history alert delivery dashboard is now scan-ready; the next value is bounded history for those guarded dashboard states.",
    does: "Tracks host-control rollup dashboard history alert delivery dashboard states without sends, playback, or provider calls.",
  },
  {
    ...
    why: "The provider alert delivery history canary now proves metadata-only no-send admission; the next value is readback for that path.",
    does: "Reads provider admission alert delivery history decisions while preserving signature proof and no-provider/no-playback boundaries.",
  },
  {
    ...
    why: "The acknowledgement alert delivery history readback now confirms redacted no-send decisions; the next value is a scan-ready dashboard for that path.",
    does: "Summarizes acknowledgement alert delivery history readback while keeping actor/token data redacted and no-send.",
  },
  {
    ...
    why: "The rate-limit history alert delivery history now tracks privacy-preserving dashboard states; the next value is alerting only when repeated states need attention.",
    does: "Classifies rate-limit history alert delivery states while keeping user content hidden and avoiding Discord sends.",
  },
  {
    ...
    why: "The board scheduler history alert delivery history canary now proves guarded no-send admission; the next value is readback for that path.",
    does: "Reads board scheduler history alert delivery decisions while preserving custom-reaction guards and no-send behavior.",
  },
];
