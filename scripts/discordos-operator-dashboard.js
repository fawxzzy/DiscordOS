...
const HIGHEST_VALUE_CATEGORIES = [
  {
    ...
    why: "The rollup dashboard now makes host-control delivery trends scannable; the next value is bounded history for those dashboard decisions.",
    does: "Tracks recent host-control rollup dashboard states without sending messages, controlling playback, or calling providers.",
  },
  {
    ...
    why: "The provider alert delivery canary now proves no-send admission; the next value is readback for those decisions.",
    does: "Reads provider admission alert delivery decisions while preserving signature proof, metadata-only state, and no-provider/no-playback boundaries.",
  },
  {
    ...
    why: "Acknowledgement alert delivery readback now confirms redacted no-send decisions; the next value is a scan-ready dashboard.",
    does: "Summarizes acknowledgement alert delivery readback while keeping actor/token data redacted and no-send.",
  },
  {
    ...
    why: "Rate-limit alert delivery history now tracks repeated dashboard states; the next value is alerting only when repeated states need attention.",
    does: "Classifies rate-limit alert delivery history without exposing user content or sending messages.",
  },
  {
    ...
    why: "The board scheduler history alert delivery canary now proves no-send admission; the next value is readback for the guarded delivery path.",
