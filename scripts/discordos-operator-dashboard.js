...
const HIGHEST_VALUE_CATEGORIES = [
  {
    ...
    why: "The host-control alert delivery dashboard now gives a scan-ready operator state; the next value is bounded history for repeated decisions.",
    does: "Tracks host-control alert delivery dashboard records without sends, playback, or provider calls.",
  },
  {
    ...
    why: "The provider alert delivery canary now proves guarded admission; the next value is readback for metadata-only state.",
    does: "Reads provider admission alert delivery decisions while preserving signature proof and no-provider/no-playback boundaries.",
  },
  {
    ...
    why: "The acknowledgement alert delivery readback now preserves redacted state; the next value is a scan-ready dashboard.",
    does: "Summarizes button acknowledgement delivery decisions while preserving actor/token redaction and avoiding Discord API sends.",
  },
  {
    ...
    why: "The rate-limit alert delivery history now tracks repeated private states; the next value is alerting for repeated patterns.",
    does: "Classifies rate-limit alert delivery history while keeping user content hidden and avoiding Discord sends.",
  },
  {
    ...
    why: "The board scheduler delivery canary now proves guarded admission; the next value is readback for custom-reaction repair state.",
    does: "Reads board scheduler alert delivery decisions while preserving custom-reaction guards and no-send behavior.",
  },
];
