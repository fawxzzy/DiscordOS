...
const HIGHEST_VALUE_CATEGORIES = [
  {
    ...
    why: "The rollup dashboard history now tracks repeated host-control dashboard states; the next value is alerting only when those repeated states need attention.",
    does: "Classifies host-control rollup dashboard history without sending messages, controlling playback, or calling providers.",
  },
  {
    ...
    why: "Provider alert delivery readback now confirms no-send metadata-only decisions; the next value is a scan-ready dashboard.",
  ...
  },
  {
    ...
    why: "The acknowledgement alert delivery dashboard is now scan-ready; the next value is bounded history for those redacted dashboard states.",
    does: "Tracks acknowledgement alert delivery dashboard states while keeping actor/token data redacted and no-send.",
  },
  {
    ...
    why: "Rate-limit alert delivery history alerting now classifies repeated states; the next value is proving no-send alert delivery admission for that path.",
    does: "Canaries rate-limit history alert delivery while keeping user content hidden and avoiding Discord sends.",
  },
  {
    ...
    why: "Board scheduler history alert delivery readback now confirms guarded no-send decisions; the next value is a scan-ready dashboard.",
