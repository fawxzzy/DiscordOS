...
const HIGHEST_VALUE_CATEGORIES = [
  {
    ...
    why: "The rollup dashboard history alerting now classifies repeated host-control states; the next value is proving no-send alert delivery admission for that path.",
    does: "Canaries host-control rollup dashboard history alert delivery without sends, playback, or provider calls.",
  },
  {
    ...
    why: "The provider alert delivery dashboard is now scan-ready; the next value is bounded history for those metadata-only dashboard states.",
    does: "Tracks provider admission alert delivery dashboard states while preserving signature proof and no-provider/no-playback boundaries.",
  },
  {
    ...
    why: "The acknowledgement alert delivery history now tracks redacted dashboard states; the next value is alerting only when repeated states need attention.",
    does: "Classifies acknowledgement alert delivery history while keeping actor/token data redacted and no-send.",
  },
  {
    ...
    why: "The rate-limit history alert delivery canary now proves no-send admission; the next value is readback for that privacy-preserving path.",
    does: "Reads rate-limit history alert delivery decisions while keeping user content hidden and avoiding Discord sends.",
  },
  {
    ...
    why: "The board scheduler history alert delivery dashboard is now scan-ready; the next value is bounded history for that guarded dashboard.",
    does: "Tracks board scheduler history alert delivery dashboard states while preserving custom-reaction guards and no-send behavior.",
  },
];
