...
const HIGHEST_VALUE_CATEGORIES = [
  {
    ...
    why: "The host-control rollup dashboard history alert delivery history alerting now classifies repeated guarded states; the next value is a guarded no-send canary.",
    does: "Proves host-control rollup dashboard history alert delivery alerting admission without sends, playback, or provider calls.",
  },
  {
    ...
    why: "The provider alert delivery history dashboard is now scan-ready; the next value is bounded history for metadata-only dashboard states.",
  ...
  },
  {
    ...
    why: "The acknowledgement alert delivery history now tracks redacted dashboard states; the next value is no-send alerting for repeated states.",
    does: "Classifies acknowledgement alert delivery history records while keeping actor/token data redacted and no-send.",
  },
  {
    ...
    why: "The rate-limit history alert delivery canary now proves guarded no-send admission; the next value is readback for that path.",
  ...
  },
  {
    ...
    why: "The board scheduler history alert delivery dashboard is now scan-ready; the next value is bounded history for that guarded path.",
