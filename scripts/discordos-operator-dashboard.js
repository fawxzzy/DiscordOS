...
const HIGHEST_VALUE_CATEGORIES = [
  {
    ...
    why: "The host-control rollup dashboard history alert delivery canary now proves no-send admission; the next value is readback for that guarded path.",
    does: "Reads host-control rollup dashboard history alert delivery decisions without sends, playback, or provider calls.",
  },
  {
    ...
    why: "The provider alert delivery history now tracks metadata-only dashboard states; the next value is alerting only when repeated states need attention.",
    does: "Classifies provider admission alert delivery history while preserving signature proof and no-provider/no-playback boundaries.",
  },
  {
    ...
    why: "The acknowledgement alert delivery history alerting now classifies redacted repeated states; the next value is proving no-send alert delivery admission for that path.",
    does: "Canaries acknowledgement alert delivery history while keeping actor/token data redacted and no-send.",
  },
  {
    ...
    why: "The rate-limit history alert delivery readback now confirms private no-send decisions; the next value is a scan-ready dashboard for that path.",
    does: "Summarizes rate-limit history alert delivery readback while keeping user content hidden and avoiding Discord sends.",
  },
  {
    ...
    why: "The board scheduler history alert delivery history now tracks guarded dashboard states; the next value is alerting only when repeated states need attention.",
    does: "Classifies board scheduler history alert delivery history while preserving custom-reaction guards and no-send behavior.",
  },
];
