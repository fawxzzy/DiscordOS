...
const HIGHEST_VALUE_CATEGORIES = [
  {
    ...
    why: "The host-control alert delivery canary now proves guarded admission; the next value is readback for that path.",
    does: "Reads host-control alert delivery canary decisions without sends, playback, or provider calls.",
  },
  {
    ...
    why: "The provider alert delivery history now tracks metadata-only dashboard states; the next value is alerting for repeated states.",
  ...
  },
  {
    ...
    why: "The acknowledgement history alerting now classifies redacted no-send states; the next value is a guarded canary.",
    does: "Proves acknowledgement alert delivery history alerting admission while preserving actor/token redaction.",
  },
  {
    ...
    why: "The rate-limit alert delivery readback now preserves guarded decisions; the next value is a scan-ready dashboard.",
    does: "Summarizes rate-limit alert delivery readback while keeping user content hidden and avoiding Discord sends.",
  },
  {
    ...
    why: "The board scheduler alert delivery history now tracks guarded dashboard states; the next value is alerting for repeated states.",
    does: "Classifies board scheduler alert delivery history while preserving custom-reaction guards and no-send behavior.",
  },
];
