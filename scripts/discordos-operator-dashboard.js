...
const HIGHEST_VALUE_CATEGORIES = [
  {
    ...
    why: "The host-control rollup dashboard history alert delivery history now tracks guarded dashboard states; the next value is no-send alerting for repeated states.",
    does: "Classifies host-control rollup dashboard history alert delivery history records without sends, playback, or provider calls.",
  },
  {
    ...
    why: "The provider alert delivery history readback now confirms metadata-only no-send admission; the next value is a scan-ready dashboard for that path.",
    does: "Summarizes provider admission alert delivery history readback while preserving signature proof and no-provider/no-playback boundaries.",
  },
  {
    ...
    why: "The acknowledgement alert delivery history dashboard is now scan-ready; the next value is bounded history for redacted no-send decisions.",
    does: "Tracks acknowledgement alert delivery history dashboard states while keeping actor/token data redacted and no-send.",
  },
  {
    ...
    why: "The rate-limit history alert delivery history alerting now classifies privacy-preserving repeated states; the next value is a guarded no-send canary.",
    does: "Proves rate-limit history alert delivery alerting admission without exposing user content or sending Discord messages.",
  },
  {
    ...
    why: "The board scheduler history alert delivery readback now confirms guarded no-send admission; the next value is a scan-ready dashboard for that path.",
    does: "Summarizes board scheduler history alert delivery readback while preserving custom-reaction guards and no-send behavior.",
  },
];
