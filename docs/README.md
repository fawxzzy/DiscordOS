...
- moderation workflow v0, moderation audit-log schema admission v0, board/card workflow v0, board/card persistence v0, board/card schema admission v0, and Music Sesh workflow v0 now have contract-only or planning-only docs plus type-only source seams, still below live feature behavior
...
- `contracts/discordos-moderation-audit-log-schema-admission-v0.md`
  - planning-only moderation audit-log schema admission boundary
  - keeps migrations, audit-row writes, and live moderation blocked
...
- `contracts/discordos-board-card-schema-admission-v0.md`
  - planning-only board/card schema admission boundary
  - keeps migrations and storage writes blocked while table shape and indexes are planned
